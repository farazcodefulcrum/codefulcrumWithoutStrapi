  ...
  return (
    <>
      <div className="work-swiper">
        <div className="row">
          <div className="col-lg-4   col-md-12 d-flex align-items-center justify-content-center flex-column">
            <div
              className="position-relative work-sec-heading-w"
              // data-aos="fade-right"
          ...
          <div
            className="col-md-12 col-lg-8 overflow-hidden"
            data-aos="fade-left"
            data-aos-duration="1300"
            data-aos-delay="300"
          >
